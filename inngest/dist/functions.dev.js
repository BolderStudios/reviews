    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 10:
          ...
          _context5.next = 13;
          return regeneratorRuntime.awrap(step.run("Fetch Yelp Reviews", function _callee4() {
        ...
        case 28:
          ...
          console.error("Error in Inngest function: ".concat(_context5.t0.message));
          _context5.next = 33;
          return regeneratorRuntime.awrap((0, _actionsHelpers.updateIsFetching)(false, clerkId));

        case 33:
          _context5.next = 35;
          return regeneratorRuntime.awrap((0, _actionsHelpers.updateFetchErrorMessage)(_context5.t0.message, clerkId));
...
function fetchYelpReviewsLogic(yelpBusinessLink, locationId, clerkId) {
  ...
  return regeneratorRuntime.async(function fetchYelpReviewsLogic$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 7:
          initialResponse = _context6.sent;
        ...
        case 45:
          ...
          console.error("Yelp fetching error: ".concat(_context6.t0.message));
          _context6.next = 50;
          return regeneratorRuntime.awrap((0, _actionsHelpers.updateIsFetching)(false, clerkId));
        ...
        case 52:
          return _context6.abrupt("return", {
            success: false,
            message: "Failed to fetch Yelp reviews: ".concat(_context6.t0.message)
          });
...
function pollYelpResults(taskId) {
  ...
  return regeneratorRuntime.async(function pollYelpResults$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 27:
          ...
          console.error("Error polling Yelp results: ".concat(_context7.t0.message));

          if (_context7.t0.response && _context7.t0.response.status === 500) {
            // Handle specific HTTP errors
            console.error("Server error: ".concat(_context7.t0.response.status));
          } else {
            console.error("General error: ".concat(_context7.t0.message));
          }

          return _context7.abrupt("return", {
            success: false,
            message: "Error polling Yelp results: ".concat(_context7.t0.message)
          });
...
function postYelpReviewTask(alias, depth) {
  var response;
  return regeneratorRuntime.async(function postYelpReviewTask$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 9:
          ...
          console.error("HTTP error posting task: ".concat(_context8.t0.message));
          throw new Error("HTTP error! Status: ".concat(_context8.t0.status));
