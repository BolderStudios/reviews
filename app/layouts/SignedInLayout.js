...
//       try {
//         const locations = await fetchSidebarLocations();

//         if (locations.success) {
//           setLocationsState(locations.locations);
//           setSelectedLocation(locations.selectedLocation);
//         }
//       } catch (error) {
...
//       <SidebarNavigation
//         passedLocations={locationsState}
...
export function SignedInLayout({ children }) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [onboardingData, locationsData] = await Promise.all([
          isOnboardingCompleteFunc(),
          fetchSidebarLocations(),
        ]);
