                ...
                <AnimatePresence>
                    {isLoaded && (
                        <>
                            ...
                            <motion.div className="relative flex flex-col px-4 sm:px-6 md:px-8 pt-4 pb-8 h-full">
                                <motion.div
                                ...
                                <div className="flex-grow flex flex-col justify-center items-center py-24 lg:py-0">
                                    <motion.div className='flex flex-col justify-center items-center'>
                                        ...
                                        <motion.p 
                                            initial={{ opacity: 0, y: 20 }}
                                            animate={{ opacity: 1, y: 0 }}
                                            transition={{ duration: 0.5, delay: 1.9, ease: customEasing }} 
                                            className={`text-stone-300 font-medium ${screenWidth <= 300 ? "text-sm" : "text-base"} md:text-lg pl-[12px] pr-[12px] md:px-24 lg:px-32 text-center leading-normal max-w-xs md:max-w-xl lg:max-w-2xl mx-auto xs:line-clamp-2`}
                                        >
                                        ...
                                        <motion.div 
                                            initial={{ opacity: 0, y: 20 }}
                                            animate={{ opacity: 1, y: 0 }}
                                            transition={{ duration: 0.5, delay: 2, ease: customEasing }} 
                                            className="flex flex-col md:flex-row gap-2 md:gap-4 mt-6 md:mt-8"
                                        >
